    ...
    extend: {
      ...
      colors: {
        ...
        trust: {
          ...
          "green-foreground": "hsl(var(--trust-green-foreground))",
        },
        hero: {
        ...
        section: {
          ...
          "dark-foreground": "hsl(var(--section-dark-foreground))",
        },
        gold: "hsl(var(--gold))",
      },
      borderRadius: {
      ...
      boxShadow: {
        ...
        'glow': '0 0 20px rgba(60, 130, 220, 0.3)',
        'glow-lg': '0 0 40px rgba(60, 130, 220, 0.35)',
      },
      keyframes: {
        "accordion-down": {
          from: { height: "0" },
