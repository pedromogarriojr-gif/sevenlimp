          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-3">
              {[
                ...
                .map((item, i) => (
                  <a key={i} href={item.url} target="_blank" rel="noopener noreferrer" className="w-11 h-11 bg-white/10 rounded-xl flex items-center justify-center hover:bg-accent transition-colors duration-200 cursor-pointer" aria-label={item.label}>
          ...
          <nav aria-label={t("footer.quickLinks")}>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={i}>
                  <a href={item.href} className="text-white/70 hover:text-accent transition-colors duration-200 flex items-center gap-2 group">
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-white/50 text-sm">
            ...
            <div className="flex gap-6">
              <a href="#" className="hover:text-accent transition-colors duration-200">{t("footer.privacy")}</a>
              <a href="#" className="hover:text-accent transition-colors duration-200">{t("footer.terms")}</a>
            </div>
          </div>
        </div>
      </div>
